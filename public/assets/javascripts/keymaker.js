...
// Salt is randomly generated and subject to change frequently
const SALT = new Uint8Array([170,15,26,174,196,215,52,183,242,93,116,163,186,36,223,246,117,79,19,116,200,40,239,108,50,42,174,81,218,0,6,186]);
...
class Locksmith {
    ...
    async digest() {
        ...
        this._digest = this.toHex(digest);
        return this._digest;
    }
